...
#include "event/multi_thread_loop.h"
#include "event/event_multi_thread.h"
...
int main(int argc, char *argv[]){
    ...
    */
    ...
    delete pEvent;
    // thread event test ==============================================================================
    gob::EventThread g_event_loop("unit_test_loop");
    ...
    // multi thread event ==============================================================================
    gob::EventThread*       g_st_loop = new gob::EventThread("single-thread");
